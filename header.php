        ...
        <div class="row d-lg-none mobile-header-row no-gutters">
            ...
            <div class="col-12">
                <div class="mobile-header-middle">
                    ...
                    <!-- CTA Button -->
                    <?php
                    $header_cta = get_field('header_cta_button', 'options');
                    if ( $header_cta && $header_cta['url'] ): ?>
                        <a href="<?php echo esc_url( $header_cta['url'] ); ?>"
                           class="mobile-cta-button button-header"
                            <?php echo $header_cta['target'] ? 'target="' . esc_attr( $header_cta['target'] ) . '"' : ''; ?>>
                            <?php echo esc_html( $header_cta['title'] ?: 'REQUEST A QUOTE' ); ?>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
                            ...
                            <div class="navbar navbar-expand-lg">
                                ...
                                if ( $header_cta && $header_cta['url'] ): ?>
                                    <div class="header-cta">
                                        <a href="<?php echo esc_url( $header_cta['url'] ); ?>"
                                           class="btn btn-primary header-cta__button"
                                            <?php echo $header_cta['target'] ? 'target="' . esc_attr( $header_cta['target'] ) . '"' : ''; ?>>
