                ...
                <?php if ( have_posts() ) : ?>
                    <?php while ( have_posts() ) : the_post(); ?>
                        <article id="product-<?php the_ID(); ?>" <?php post_class('entry product-single'); ?>>
                            ...
                            <?php if ( has_post_thumbnail() ) : ?>
                                <div class="entry__thumb product-single__image">
                                    <?php the_post_thumbnail( 'large', array( 'class' => 'product-single__img' ) ); ?>
                                </div>
                            <?php endif; ?>

                            <div class="entry__content product-single__content">
                                <?php the_content( '', true ); ?>
                            </div>
                            ...
                            if ( $categories && !is_wp_error( $categories ) ): ?>
                                <div class="product-single__categories">
                                    <h6 class="entry__cat"><?php _e( 'Product Category: ', 'default' ); ?>
                                        <?php
                            ...
                            <div class="product-single__navigation">
                                <a href="<?php echo get_permalink( get_page_by_path( 'products' ) ); ?>" class="btn btn--teal">
